	...
	initialize : function() {
		...
		window.attachEvent('onscroll', function() { 
											if(!CodePress.scrolling){
												if(!CodePress.multiscrolling){
													CodePress.multiscrolling = true;
													setTimeout(function(){CodePress.syntaxHighlight('scroll');CodePress.multiscrolling = false;},1)
												}
											}
										});
